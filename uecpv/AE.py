...
x = pd.read_csv("C:/Users/GOOD DAY/PycharmProjects/Feature extraction/HOG_mnist.csv")
x=np.array(x)
print(np.shape(x))
...
path = F"C:/Users/GOOD DAY/PycharmProjects/Datasets and AE whieghts/AE_weights"
...
autoencoder.load_weights(path + '/ae_weights_mnist.h5')
...
np.savetxt('mnist_hog_ae.csv', data, delimiter=',', fmt='%f')